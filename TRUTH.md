...
- Canonical screenshot capture now removes every prior PNG and uses scrot overwrite mode, preventing `_000` suffixed stale images from satisfying a later run; the fresh Docker/Xvfb gate produced only the five expected base-named 1280x800 captures.
