...
| Software Catalogue / AppImage | 8 | **7/8** | Metadata now requires complete control-free fields, HTTPS host URLs, trusted SHA-256 and a valid ELF payload; redirects are HTTPS-only and bounded. Kdenlive 24.05.0, GIMP 3.2.4 and Audacity 3.7.7 have release-published digests; Inkscape 1.3.2 is pinned to an independently measured official asset digest. OBS remains browse-only because its official release has no Linux AppImage. |
