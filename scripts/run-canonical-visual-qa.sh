...
for command in Xvfb dbus-run-session xdotool scrot openbox pcmanfm; do
...
cp -a themes/slopos-openbox-classic/openbox-3/. "$HOME/.themes/slopos-openbox-classic/openbox-3/"
cp -a themes/slopos-openbox-graphite/openbox-3/. "$HOME/.themes/slopos-openbox-graphite/openbox-3/"
cp -a themes/slopos-openbox-oled/openbox-3/. "$HOME/.themes/slopos-openbox-oled/openbox-3/"
...
dbus-run-session -- bash -c '
  ...
  exec "$2"
' bash "$DBUS_ENV" ./scripts/start-slopos-i >"$OUT_DIR/session.log" 2>&1 &
SESSION_PID=$!
